...
export default function MobileGate() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 text-center md:hidden bg-terminal-bg">
      ...
      <p className="font-serif text-terminal-text max-w-sm leading-relaxed mb-6">
        This game needs a wider screen. On a tablet, try rotating to landscape
        mode. Your organisation&rsquo;s tech stack deserves a proper viewport.
      </p>
